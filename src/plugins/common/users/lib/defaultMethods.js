...
function initDefaultMethods(henta) {
    ...
    usersPlugin.method('sendBuilder', (self, data) => botPlugin.createBuilder(data, { peerId: self.vkId, henta }));
}
exports.default = initDefaultMethods;
